...
class ContainerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testResolveAliasSet()
    {
        ...
        $refProp->setValue($this->fixture, ['foo' => 'bar']);
    ...
    public function testResolveAliasSameAsKey()
    {
        ...
        $refProp2->setValue($this->fixture, ['bar' => 'foo']);

        $this->assertSame(
            $this->fixture->get('foo'),
            $this->fixture->get('bar'),
            'When retrieving an alias of a class, both (original and alias) should return the same object instance.'
        );
    }
    ...
    {
        $object = $this->fixture->buildObject('Yaapi\\DI\\Tests\\Stub1');

        $this->assertInstanceOf(
            'Yaapi\\DI\\Tests\\Stub1',
            $object,
    ...
    {
        $this->fixture->set('Yaapi\\DI\\Tests\\StubInterface', function () {
            return new Stub1;
        }
        );

        $object = $this->fixture->buildObject('Yaapi\\DI\\Tests\\Stub2');
    ...
    {
        $object = $this->fixture->buildSharedObject('Yaapi\\DI\\Tests\\Stub1');

        $this->assertSame(
            $object,
            $this->fixture->get('Yaapi\\DI\\Tests\\Stub1'),
    ...
    public function testCreateChild()
    {
        ...
        $this->assertAttributeInstanceOf(
            ...
            'parent',
            $child,
            'When creating a child container, the $parent property should be an instance of Yaapi\\DI\\Container.'
        );
    ...
    public function testGetMethodArgsFromContainer()
    {
        ...
        $reflectionClass = new \ReflectionClass('Yaapi\\DI\\Tests\\Stub2');
    ...
    public function testGetMethodArgsConcreteClass()
    {
        ...
        $reflectionClass = new \ReflectionClass('Yaapi\\DI\\Tests\\Stub5');
        $constructor = $reflectionClass->getConstructor();

        $args = $reflectionMethod->invoke($this->fixture, $constructor);

        $this->assertInstanceOf(
            'Yaapi\\DI\\Tests\\Stub4',
            $args[0],
    ...
    public function testGetMethodArgsDefaultValues()
    {
        ...
        $reflectionClass = new \ReflectionClass('Yaapi\\DI\\Tests\\Stub6');
        $constructor = $reflectionClass->getConstructor();
     ...
     * @since   1.0
     *
     * @expectedException  \Yaapi\DI\Exception\DependencyResolutionException
     */
    public function testGetMethodArgsCantResolve()
    {
        ...
        $reflectionClass = new \ReflectionClass('Yaapi\\DI\\Tests\\Stub7');
        $constructor = $reflectionClass->getConstructor();
    ...
    {
        $this->fixture->set('foo', [$this, 'callMe']);
     ...
     * Yaapi\DI\Container instance to the callback.
     *
     * @return  void
     *
     * @since   1.0
    ...
    public function testExists()
    {
        ...
        $reflection->setValue($this->fixture, ['foo' => 'bar']);
    ...
    {
        $mock = $this->getMock('Yaapi\\DI\\ServiceProviderInterface');
    ...
    public function testResolveAliasOfParentContainer()
    {
        ...
        $refProp2->setAccessible(true);
        $refProp2->setValue($parent, ['bar' => 'foo']);
        ...
        $this->assertSame(
            $this->fixture->get('foo'),
            $this->fixture->get('bar'),
            'When retrieving an alias of a class which calls the parent container, 
			both the original and the alias should return the same object instance.'
        );
    }
